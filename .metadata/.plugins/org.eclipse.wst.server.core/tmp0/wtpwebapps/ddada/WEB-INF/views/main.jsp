...
<!--           <div class="carousel-caption d-none d-md-block">
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style="width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420015" class="card-link"> <br> 운영체제</a>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420011" class="card-link"> <br> DataBase</a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420007" class="card-link"> <br> 네트워크</a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420019" class="card-link"> <br> 해킹 및 정보보안 </a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420014" class="card-link"> <br> 클라우드 </a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420001" class="card-link"> <br> 정보기술</a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
  ...
  <div class="container" id = "sqld" style = "float : left; margin:10px; width : 250px;">
        ...
        <tr>
           <td style = "width : 250px;">
            <h2 style = "font-size : 25px; font-weight : 1000"><a href="http://localhost:8085/myapp/Information1.do?lec_num=441420021" class="card-link"> <br> 기타 </a>
            <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddaySqld" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
