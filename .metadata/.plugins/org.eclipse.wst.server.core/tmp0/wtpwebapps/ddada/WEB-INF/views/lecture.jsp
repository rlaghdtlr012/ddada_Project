            ...
            <div role="tabpanel" class="tab-pane active" id="all" align="left">           
               <c:forEach items="${list}" var = "list">
                     ...
                     <ul>
                        ...
                        <a class="btn_b4" href="#"
                           onclick = "window.open('${contextPath}/video.do?lec_num=${list.lec_num}','window_name',
                           'width=900,height=650,location=no,status=no,scrollbars=yes');">
                           <img src="${contextPath}/resources/Image/play.png" style="width:60px; height:65px; margin-top : -70px;" hspace=70 align="right">
                        </a>
                     <a class="btn_b4" href="${contextPath}/member/mainPractice2.do" >
                     <img src="${contextPath}/resources/Image/book.png" style="width:60px; height:75px; margin-top : -80px;"  align="right" ></a>
                     <hr>
               </c:forEach>  
            </div>
