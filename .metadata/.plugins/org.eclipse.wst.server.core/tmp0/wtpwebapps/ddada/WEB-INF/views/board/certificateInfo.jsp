...
<%--     <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
   ...
   <script type="text/javascript">
      function counterSqld(){
         var dday = new Date("2022.05.28").getTime(); //디데이
    ...
    <div class="container" id = "sqld" style = "float : left; margin-top:10px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>시험시간 : 10:00 ~ 11:30 <span class = "sqldinfo"> <a href="https://quizeey.com/sqlp-developer" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a></span>
    ...
    <div class="container" id = "informationProcessing" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>필기시험일 : 2022.07.02(일) <span id = "informationCerti1"><a href="https://www.q-net.or.kr/rcv001.do?id=rcv00103&gSite=&gId=" class="card-link" target="_blank">&nbsp;&nbsp;<u>접수하기(링크클릭)</u></a></span></h6><br>
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>시험 시간 : 60분, 합격점 : 700/1000점 &nbsp;<span id = "informationMS2"> <a href="https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWSRk3" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>실기시험일 : 2022.09.25(일)<span style = "margin-left : 281px;" id = "informationMS2"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
    ...
    <div class="container" id = "linux" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>1차시험일 : 2022.7.26(일)<span style = "margin-left : 300px;" id = "informationMS2"><a href="https://www.ihd.or.kr/introducesubject1.do" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6><br>
            <h6>2차시험일 : 2022.9.03(토)<span style = "margin-left : 294px;"id = "informationMS2"> <a href="https://www.comcbt.com/xe/r2" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
    ...
    <div class="container" id = "informationSecure" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>실기시험일 : 2022.08.13(토)<span style = "margin-left : 281px;"> <a href="https://www.q-net.or.kr/cst006.do?id=cst00601&code=1203&gSite=&gId=" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
    ...
    <div class="container" id = "informationManage" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>실기시험일 : 2022.10.01(토)<span style = "margin-left : 281px;"> <a href="https://q.fran.kr/%EC%8B%9C%ED%97%98/%EC%A0%95%EB%B3%B4%EA%B4%80%EB%A6%AC%EA%B8%B0%EC%88%A0%EC%82%AC" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
    ...
    <div class="container" id = "comUse" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>필기시험일 : 매주 주말<span style = "margin-left : 331px;"><a href="https://license.korcham.net/indexmain.jsp" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6><br>
            <h6>실기시험일 : 매주 주말<span style = "margin-left : 328px;"> <a href="https://license.korcham.net/co/examguide02.do?cd=0103&mm=21" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
     ...
     <div class="container" id = "word" style = "float : left; margin-top:20px;">
        ...
        <tr>
           <td style = "width : 1100px;">
            ...
            <h6>분류 : 기타 <span style = "margin-left : 395px;">접수기간 : 상시가능</span></h6><br>
            <h6>필기시험일 : 매주 주말<span style = "margin-left : 331px;"><a href="https://license.korcham.net/indexmain.jsp" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6><br>
            <h6>실기시험일 : 매주 주말<span style = "margin-left : 328px;"> <a href="https://license.korcham.net/co/examguide02.do?cd=0102&mm=22" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
            <span class = "likebutton">
               <i class="fa-regular fa-heart"></i>
               <span class = "writebutton">
               <i class="fa-solid fa-pen"></i>
