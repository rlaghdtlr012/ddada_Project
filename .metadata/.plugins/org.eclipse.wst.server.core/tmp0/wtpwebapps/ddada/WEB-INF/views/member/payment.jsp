                        ...
                        <dd>
                           <div class = "c_order_selectbox">
                              ...
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" style = "position : absolute; left : 540px;">
                                <label class="form-check-label" for="flexCheckDefault" style = "position : absolute; left : 550px;">   
                                   SMS 수신 동의
                                </label>
                              </div>
                              </span>
...
<%--                <c:forEach var = "a" items = "${takeAaList}">
                  ...
                  <dl>
                     <div class = "feild">
                        <dd>
                           ...
                           <input type = "text" placeholder = "받는사람" style = "position : absolute; top : 480px; left : 295px;" >
                        </dd>                                                      
                     </div>
                     <div class = "field">
                        <dd style = "position : absolute; left : 295px; top : 515px;">
                     ...
                     <div>
                        <dd>
                           <input type= "text" placeholder = "기본주소" style = "position : absolute; top : 557px; left : 295px; width : 300px;">   
                        </dd>
                     </div>
                     <div>
                        <dd>
                           <input type = "text" placeholder = "상세 주소 및 상세 건물명" style = "position : absolute; top : 600px; left : 295px; width : 300px;">
                        </dd>
                     </div>
            ...
            <h2 style = "font-size: 18px;font-weight: bold; line-height: 27px;  color: #111;    height : 27px; position : absolute; top : 715px; " class = "pro" >주문상품</h2>
            <!-- </div> -->
            <br><br>
                  ...
                  <ul>
                     <li>                                                
                        <div style = "width : 230px; height : 180px; border-left : 0px;" ;><!-- 사진 -->
                           <image src = "/resources/Image/${selectTakeList.BOOK_IMAGE}"  style = "width : 135px; height : 145px;   position : absolute; left : 315px; top : 760px;">
                        </div>
                        <div><!-- 담는박스 -->
                           <div style = "width :230px; height : 180px;  display : inline; "><!-- 상세정보 -->
                              
                              <p style = " position : absolute; left : 470px; top : 780px;">${selectTakeList.BOOK_NAME} <br></p>
                           </div>
                           ...
                           <div>
                              <a href = "" style = "position : absolute; left : 770px; top : 781px;"><p>연관 강의 보러가기</p></a>
                           </div>
                           <div>
                  ...
                  <div class = "amount">
                     ...
                     <div class = "order_cash">
                        <div style = "width : 297px; height : 35px; margin-top : 25px;">
                           ...
                           <h5 style = "float : right; margin-top:5px;">+</h5> 
                           <h5 style = "float : right; margin-top:5px;" class = "realcash">${selectTakeList.BOOK_PRICE}</h5>
            ...
            <div class = "tab_container" style = "position : absolute; left : 300px; top : 940px;margin-top : 8px;">                                       
            ...
            <div>
               <select style = "float : left; width : 150px; height : 20px;">
