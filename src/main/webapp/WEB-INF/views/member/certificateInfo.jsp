...
<html lang="en">
  <head>
	...
	<script type="text/javascript">
		function counterSqld(){
			var dday = new Date("2022.04.23").getTime(); //디데이
		...
		function counterCloud(){
			var dday = new Date("2022.06.23").getTime(); //디데이
			setInterval(function(){
				var now = new Date(); //현재 날짜 가져오기
				var distance = dday - now;
				var d = Math.floor(distance / (1000 * 60 * 60 * 24));
		...
		function counterNetwork(){
			var dday = new Date("2022.07.23").getTime(); //디데이
			setInterval(function(){
				var now = new Date(); //현재 날짜 가져오기
				var distance = dday - now;
				var d = Math.floor(distance / (1000 * 60 * 60 * 24));
  ...
  <body>
    ...
    <div class="container" id = "informationProcessing" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<h6>분류 : 정보기술 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 필기=57.3% , 실기=17.7%</span></h6> 
        ...
        <div class="container" id = "MSAzure" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                    <span class="badge badge-light" id = "ddayCloud" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
                </h2>
				<hr/>
    ...
    <div class="container" id = "linux" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<hr/>
				<h6>공인 자격 제 2022-01호 <span class = "sqldinfo">접수기간 : 2022.09.27(화) ~ 2022.09.30(금)</span></h6>
				<h6>분류 : 운영체제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 20%</span></h6> 
				<h6>시험일 : 2022.10.30(일)<span class = "sqldinfo"><a href="https://www.icqa.or.kr/cn/" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6>
				<h6>합격발표 : 2022.11.01(화)<span id = "networkInfo"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
				<span class = "likebutton">
					<i class="fa-regular fa-heart"></i>
    ...
    <div class="container" id = "informationSecure" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<hr/>
				<h6>공인 자격 제 2022-01호 <span class = "sqldinfo">접수기간 : 2022.09.27(화) ~ 2022.09.30(금)</span></h6>
				<h6>분류 : 정보보안&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 20%</span></h6> 
				<h6>시험일 : 2022.10.30(일)<span class = "sqldinfo"><a href="https://www.icqa.or.kr/cn/" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6>
				<h6>합격발표 : 2022.11.01(화)<span id = "networkInfo"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
				<span class = "likebutton">
					<i class="fa-regular fa-heart"></i>
    ...
    <div class="container" id = "amazon" style = "float : left; margin-top:20px;">
   		<table  class = "Cloud">
		  <tr>
		     <td style = "width : 1100px;">
				<h2><a href="${contextPath}/board/amazonAWS.do" class="card-link">아마존 AWS</a>
				<button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                  margin: 0px; padding: 0px; box-shadow: none;">
                   <span class="badge badge-light" id = "ddayNetwork" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                </button>
				...
				<hr/>
				<h6>공인 자격 제 2022-01호 <span class = "sqldinfo">접수기간 : 2022.09.27(화) ~ 2022.09.30(금)</span></h6>
				<h6>분류 : 클라우드&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 20%</span></h6> 
				<h6>시험일 : 2022.10.30(일)<span class = "sqldinfo"><a href="https://www.icqa.or.kr/cn/" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6>
				<h6>합격발표 : 2022.11.01(화)<span id = "networkInfo"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
				<span class = "likebutton">
					<i class="fa-regular fa-heart"></i>
    ...
    <div class="container" id = "informationManage" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<hr/>
				<h6>공인 자격 제 2022-01호 <span class = "sqldinfo">접수기간 : 2022.09.27(화) ~ 2022.09.30(금)</span></h6>
				<h6>분류 : 정보기술&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 20%</span></h6> 
				<h6>시험일 : 2022.10.30(일)<span class = "sqldinfo"><a href="https://www.icqa.or.kr/cn/" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6>
				<h6>합격발표 : 2022.11.01(화)<span id = "networkInfo"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
				<span class = "likebutton">
					<i class="fa-regular fa-heart"></i>
    ...
    <div class="container" id = "comUse" style = "float : left; margin-top:20px;">
		  ...
		  <tr>
		     <td style = "width : 1100px;">
				...
				<hr/>
				<h6>공인 자격 제 2022-01호 <span class = "sqldinfo">접수기간 : 2022.09.27(화) ~ 2022.09.30(금)</span></h6>
				<h6>분류 : 기타&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class = "sqldinfo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;실합격률 : 20%</span></h6> 
				<h6>시험일 : 2022.10.30(일)<span class = "sqldinfo"><a href="https://www.icqa.or.kr/cn/" class="card-link" target="_blank"><u>접수하기(링크클릭)</u></a></span></h6>
				<h6>합격발표 : 2022.11.01(화)<span id = "networkInfo"> <a href="https://www.icqa.or.kr/cn/board/dataroom" class="card-link" target="_blank"><u>기출문제(링크클릭)</u></a>
				<span class = "likebutton">
					<i class="fa-regular fa-heart"></i>
