...
*/
	...
	@RequestMapping(value= "/member/certificateInfo.do", method = RequestMethod.GET )
	   public String create1() {
		
	      return "/member/certificateInfo";
	   }
	...
	@RequestMapping(value= "/board/sqld.do", method = RequestMethod.GET )
	...
	public String create8() {
	 return "/board/informationSecure";
		...
		/*
		 * @RequestMapping(value= "/board/amazonAWS.do", method = RequestMethod.GET )
		 * public String create9() { return "/board/amazonAWS"; }
		 */
	...
	@RequestMapping(value= "/board/amazonAWS.do", method = RequestMethod.GET )
	public String create11() {
	 return "/board/amazonAWS";
	 }
	
	@RequestMapping(value = "/board/computerUse.do", method =  {RequestMethod.GET, RequestMethod.POST})
	public ModelAndView takeCertiList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return mav;
			...
			/*
			 * // @Override public String mapForm(HttpServletRequest request,
