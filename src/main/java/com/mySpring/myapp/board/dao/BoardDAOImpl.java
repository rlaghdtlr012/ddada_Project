...
public class BoardDAOImpl implements BoardDAO {
   ...
   */
	...
	@Override
	public List selectAllcertiInformation() throws DataAccessException {
		List<BoardVO> CertiList = CertiList = sqlSession.selectList("mapper.board.selectAllcertiInformation");
		return CertiList;
	}
