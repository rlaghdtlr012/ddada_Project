	...
	<div class="row" style="margin-top: 70px;">
      <div class="col-9" style="margin-top: -45px;">
		...
		<form id="frmOS" method="post" action="${contextPath}/insertOSLecture.do" style="text-align:center;">
			...
			<input type="hidden" name="book_num" value="${membervo.book_num}" />
			...
			<input type="IMAGE" id="but"  src="${contextPath}/resources/Image/book.png" 
			style="width:70px; height:90px; margin-top : -73px;" hspace=8; align="right" value="Submit">
		</form>
              <input type="IMAGE" value="button"  onclick="window.open('${contextPath}/video.do?lec_num=${membervo.lec_num}','window_name',
      'width=900,height=650,location=no,status=no,scrollbars=yes');"
                  src="${contextPath}/resources/Image/play.png" style="width:70px; height:75px; margin-top : -60px;" hspace=8; align="right">  
      ...
      <table style="margin-top: 15px; width : 1300px;">
       ...
       <form id="frmOS" method="post" action="${contextPath}/insertOSLecture.do" style="text-align:center;">
			...
			<div style="align: center;">
				<input type="button" value="미리보기" class="btn_b4" href="#"
