             ...
             <div class="container1" style = "margin-top:10px;">
              ...
              <tr>
                 <td style = "padding-left : 30px;">
                  <h2><a href="http://localhost:8086/myapp/Information1.do?lec_num=441420011" class="card-link">SQLD 노랑이 책 파헤치기</a>
                  ...
                  <span class = "likebutton">
                     ...
                     <a class="btn btn-primary" href="http://localhost:8086/myapp/Information1.do?lec_num=441420011" role="button" style = "float:right; margin-top:-10px;">수강하기</a>
                  </span></h6>
                 </td>
              </tr>
            </table>
          ...
          <div class="container1" style = "margin-top:10px;">
              ...
              <tr>
                 <td style = "width : 1000px; padding-left : 30px;">
                  <h2><a href="http://localhost:8086/myapp/Information1.do?lec_num=441420012" class="card-link">SQLD로 DB정복</a>
                  <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                        margin: 0px; padding: 0px; box-shadow: none;">
                         <span class="badge badge-light" id = "ddayNetwork" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                      </button>
                  ...
                  <span class = "likebutton">
                     ...
                     <a class="btn btn-primary" href="http://localhost:8086/myapp/Information1.do?lec_num=441420012" role="button" style = "float:right; margin-top:-10px;">수강하기</a>
                  </span></h6>
                 </td>
              </tr>
            </table>
           ...
           <div class="container1" style = "margin-top:10px;">
              ...
              <tr>
                 <td style = "width : 1000px; padding-left : 30px;">
                  <h2><a href="http://localhost:8086/myapp/Information1.do?lec_num=441420013" class="card-link">준면쌤과 SQLP 합격의 길 걷기</a>
                  <button type="button" class="btn btn-primary" style="font-size:medium; background-color: rgba(255, 255, 255, 255);
                        margin: 0px; padding: 0px; box-shadow: none;">
                         <span class="badge badge-light" id = "ddayNetwork" style="padding-top:0px; padding-bottom:0px; margin-top: 5px; color:rgb(255, 40, 40);"></span>
                      </button>
                  ...
                  <span class = "likebutton">
                     ...
                     <a class="btn btn-primary" href="http://localhost:8086/myapp/Information1.do?lec_num=441420013" role="button" style = "float:right; margin-top:-10px;">수강하기</a>
                  </span></h6>
                 </td>
              </tr>
            </table>
